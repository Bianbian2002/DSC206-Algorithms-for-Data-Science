...
\end{align*}
Numerically, $(7/8)^{300}=e^{300\ln(7/8)}\approx e^{-40.06}\approx 4.4\times 10^{-18}$, and the other two are vastly smaller. Thus $f(1),f(2),f(3)$ all equal $1$ to great precision, giving
\[
